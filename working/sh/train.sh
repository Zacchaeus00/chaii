#!/bin/bash
#SBATCH --job-name=mark-xlm-roberta-long-base-maxlen4096-stride2048         # 任务名
...
#SBATCH --output=mark-xlm-roberta-long-base-maxlen4096-stride2048.out         # 正常输出写入的文件
#SBATCH --error=mark-xlm-roberta-long-base-maxlen4096-stride2048.err          # 报错信息写入的文件
