#!/bin/bash
#SBATCH --job-name=torchscript_convertor         # 任务名
...
python -u torchscript_convertor.py \
--model_checkpoint /gpfsnyu/scratch/yw3642/chaii/input/google-muril-large-cased \
--weight_path /gpfsnyu/scratch/yw3642/chaii/working/model/56ec06dd62a6c4fc0e47aa50b5fa4e46
echo "FINISH"                       # 输出起始信息