#!/bin/bash
#SBATCH --job-name=xlm-roberta-base           # 任务名
...
#SBATCH --output=xlm-roberta-base-maxlen512-stride128.out         # 正常输出写入的文件
#SBATCH --error=xlm-roberta-base-maxlen512-stride128.err          # 报错信息写入的文件
