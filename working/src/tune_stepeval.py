...
experiment_name = 'xrobl-tune_lr_ep-adamw-bs4-cosann0.05wu-fold0-stepeval'
...
def objective(trial):
    ...
    hyp = {
        ...
        'lr': trial.suggest_loguniform('lr', 1e-7, 5e-5),
